...
export const metadata: Metadata = {
  title:
    "ADIKARA — Aplikasi Data dan Informasi Ketenagakerjaan Area Regional Paser",
  description:
    "ADIKARA: Tindakan mulia yang menjunjung kehormatan, integritas, dan tanggung jawab dalam layanan ketenagakerjaan di Area Regional Paser.",
};
...
export default async function RootLayout({
  ...
  try {
    ...
    settings = {
      ...
      instansi_logo: resolveImageSrc(cfg?.instansi_logo, ""),
    };
  } catch {}
