  ...
  return (
    <main className="transition-all duration-300 min-h-screen bg-gray-50 pt-6 pb-8 lg:ml-64">
      <div className="px-4 sm:px-6">
        {selectedReport === null && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div
                onClick={() => setSelectedReport("lowongan")}
              ...
              >
                ...
                <p className="text-gray-500 text-sm">
                  Laporan detail mengenai lowongan kerja yang tersedia dan
                  status penempatan pencari kerja.
                </p>
              </div>

              {/* Card 2: Laporan IPK */}
              <div
                onClick={() => setSelectedReport("ipk")}
                className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all cursor-pointer group"
              >
                <div className="flex items-center gap-4 mb-4">
        ...
        {selectedReport === "ipk" && (
          <LaporanIPKView onBack={() => setSelectedReport(null)} />
        )}

        {selectedReport === "lowongan" && (
          <LaporanLowonganView onBack={() => setSelectedReport(null)} />
        )}
      </div>
    </main>
  );
