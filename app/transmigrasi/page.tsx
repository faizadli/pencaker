  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setRelatedNews(
          mapped.filter((n) => n.kategori.toLowerCase() === "transmigrasi"),
        );
      } catch {
        setRelatedNews([]);
      } finally {
      ...
      <section className="public-hero relative py-12 sm:py-16 px-4 sm:px-6 ring-1 ring-black/[0.06]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg text-white/95 leading-relaxed">
            Perumusan kebijakan, koordinasi, penyiapan pemukiman, penempatan,
            dan pembinaan kawasan
          </p>
        </div>
      </section>
                ...
                <div className="mt-4 space-y-3">
                  {relatedNews.length === 0 && (
                    <p className="text-sm text-gray-500">
                      Belum ada berita dengan kategori Transmigrasi.
                    </p>
                  )}
                  {(() => {
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2 text-sm md:text-base">
                Gambaran penempatan, penyiapan pemukiman, dan sebaran kawasan
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
