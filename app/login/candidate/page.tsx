...
export default function CandidateLogin() {
  ...
  return (
    <LoginPageShell
      ...
      heroSubtitle="Satu pintu masuk untuk lamaran, pelatihan, dan informasi ketenagakerjaan."
      cardTitle="Masuk ke akun Pencaker"
      cardDescription="Gunakan email atau nomor HP yang terdaftar beserta password Anda."
      belowForm={
        <>
          Belum punya akun?{" "}
          <Link
